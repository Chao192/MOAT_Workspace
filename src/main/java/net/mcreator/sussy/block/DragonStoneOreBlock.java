...
import net.mcreator.sussy.procedures.DragonStoneOreBlockDestroyedByPlayerProcedure;
...
public class DragonStoneOreBlock extends Block {
	...
	public boolean onDestroyedByPlayer(BlockState blockstate, Level world, BlockPos pos, Player entity, boolean willHarvest, FluidState fluid) {
		...
		DragonStoneOreBlockDestroyedByPlayerProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), entity);
		return retval;
	}
}
